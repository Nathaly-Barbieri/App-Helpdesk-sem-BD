...
<?php
  ...
  $arquivo = fopen('../../../xampp/app_help_desk/arquivo.hd', 'r');
...
<html>
  ...
  <body>
    ...
    <nav class="navbar navbar-dark bg-dark">
      ...
      <ul class="navbar-nav"><li class="nav-item"><a href="logoff.php">SAIR</a></li></ul>
    </nav>
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="card mb-3 bg-light">
                <div class="card-body">
                  <h5 class="card-title"><?php echo $chamado_dados[0] . ' - ' . $chamado_dados[1];?></h5>
